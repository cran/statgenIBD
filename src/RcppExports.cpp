...
// calcIBD
List calcIBD(CharacterVector& popType, CharacterVector& markerFile, CharacterVector& mapFile, Nullable<DataFrame> evalPos, Nullable<double> evalDist, const bool& grid, const bool& verbose);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Nullable<double> >::type evalDist(evalDistSEXP);
